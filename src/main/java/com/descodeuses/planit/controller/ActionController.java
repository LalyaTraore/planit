...
public class ActionController {
   ...
   public ActionController(ActionService actionService, UserRepository userRepository) {
    ...
    public ResponseEntity<List<ActionDTO>> getAll() {
       ...
       @PostMapping
    public ActionDTO createAction(@RequestBody ActionDTO dto, Principal principal) {
